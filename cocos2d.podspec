#
#  Be sure to run `pod spec lint cocos2d-iphone.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of cocos2d-iphone in Markdown format.
  ...
  s.author             = { "S0r13n" => "email@address.com" }
  # Or just: s.author    = "S0r13n"
  # s.authors            = { "S0r13n" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/S0r13n"
  ...
  s.source       = { :git => "https://github.com/S0r13n/cocos2d-iphone.git", :tag => "release-3.1.1" }
